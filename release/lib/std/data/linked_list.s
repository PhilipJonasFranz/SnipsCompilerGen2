...
List.LinkedList.get.L3:                      /* Evaluate condition */
    ...
    ldr r0, [r1, #4]                         /* Load field from struct */
    ldr r1, .POOL@1321795593_1_L2_NULL       /* Load null address */
    cmp r0, r1
...
List.LinkedList.get.L7: 
    ldmfd sp!, {r3-r5}
    bx lr
.POOL@1321795593_1_L2_NULL: .word NULL
...
List.LinkedList.create_P_1:                  /* Function: List.LinkedList.create, Provisos: INT */
    ...
    push { r3 }
    mov r0, #0
    ldr r1, .POOL@1321795593_2_L2_NULL       /* Load null address */
    ldr r2, .POOL@1321795593_2_L2_NULL       /* Load null address */
    stmfd sp!, {r0-r2}
    ldr r0, .POOL@1321795593_2_List.LinkedList
    push { r0 }
    bl init_P_5                              /* Call init */
    ldmfd sp!, {r3, pc}
.POOL@1321795593_2_List.LinkedList: .word List.LinkedList
.POOL@1321795593_2_L2_NULL: .word NULL
...
List.LinkedList.clear_P_1: 
    ...
    lsl r1, r0, #2
    ldr r4, [r1, #4]
List.LinkedList.clear.L1: 
    ldr r1, .POOL@1321795593_2_L2_NULL
    cmp r4, r1
    beq List.LinkedList.clear.L2
    mov r0, r4
    bl free
    lsl r1, r4, #2
    ldr r4, [r1, #4]
    b List.LinkedList.clear.L1
List.LinkedList.clear.L2: 
    ldr r0, .POOL@1321795593_2_L2_NULL
    lsl r1, r3, #2
    str r0, [r1, #4]
    ldr r0, .POOL@1321795593_2_L2_NULL
    lsl r1, r3, #2
...
/* Initialize the new List Node, set the next pointer to null */
    ...
    ldmfa r0, {r0-r2}
    stmfd sp!, {r0-r2}
    ldr r0, .POOL@1321795593_0_L2_NULL
    push { r0 }
    ldr r0, .POOL@1321795593_0_List.ListNode
    push { r0 }
    bl init_P_5
    ...
    lsl r1, r3, #2
    ldr r0, [r1, #4]
    ldr r1, .POOL@1321795593_0_L2_NULL
    cmp r0, r1
    bne List.LinkedList.add.L1
    lsl r1, r3, #2
    str r4, [r1, #4]
...
List.LinkedList.get.L0: 
    lsl r1, r3, #2
    ldr r5, [r1, #4]
List.LinkedList.get.L3: 
    cmp r4, #0
    beq List.LinkedList.get.L4
    lsl r1, r5, #2
    ldr r0, [r1, #4]
    ldr r1, .POOL@1321795593_1_L2_NULL
    cmp r0, r1
    bne List.LinkedList.get.L5
    lsl r1, r3, #2
    add r1, r1, #16
...
/* Initialize list, set pointers to null */
    ...
    mov r0, #0
    ldr r1, .POOL@1321795593_2_L2_NULL
    ldr r2, .POOL@1321795593_2_L2_NULL
    stmfd sp!, {r0-r2}
    ldr r0, .POOL@1321795593_2_List.LinkedList
    push { r0 }
    bl init_P_7
...
/* Initialize the new List Node, set the next pointer to null */
    ...
    ldr r0, [fp, #16]
    push { r0 }
    ldr r0, .POOL@1321795593_0_L1_NULL
    push { r0 }
    ldr r0, .POOL@1321795593_0_List.ListNode
    push { r0 }
    bl init_P_6
    ...
    lsl r1, r3, #2
    ldr r0, [r1, #4]
    ldr r1, .POOL@1321795593_0_L1_NULL
    cmp r0, r1
    bne List.LinkedList.add.L1
    lsl r1, r3, #2
    str r4, [r1, #4]
...
/* Remove first element */
    lsl r1, r3, #2
    ldr r0, [r1, #4]
    ldr r1, .POOL@1321795593_1_L1_NULL
    cmp r0, r1
    ldmfdeq sp!, {r3-r5, pc}
    lsl r1, r3, #2
    ldr r5, [r1, #4]
...
/* Only one element in list */
    ...
    ldr r0, .POOL@1321795593_1_L1_NULL
    lsl r1, r3, #2
    str r0, [r1, #8]
...
/* Cut out element and set next pointers */
    ...
    str r3, [r1, #4]
    ldmfd sp!, {r3-r5, pc}
.POOL@1321795593_1_L1_NULL: .word NULL
...
List.LinkedList.set_P_1: 
    ...
    lsl r1, r0, #2
    ldr r6, [r1, #4]
List.LinkedList.set.L1: 
    cmp r4, #0
    beq List.LinkedList.set.L2
    lsl r1, r6, #2
    ldr r0, [r1, #4]
    ldr r1, .POOL@1321795593_2_L1_NULL
    cmp r0, r1
...
List.LinkedList.set.L5: 
    ldmfd sp!, {r4-r6}
    bx lr
.POOL@1321795593_2_L1_NULL: .word NULL
