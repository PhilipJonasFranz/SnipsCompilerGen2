# Snips Compiler Gen.2 v.2.4.0-RELEASE
...
## Feature Roadmap
### v.3.0.0-RELEASE: Exception Handling
 - Implement Exception Handling, implement watchpoints, implement exception signaling
